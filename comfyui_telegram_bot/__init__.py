...
async def generate_image_task(update: Update, context: ContextTypes.DEFAULT_TYPE, params: GenerationParameters) -> None:
    try:
        prompt = params.prompt
        prompt = params.prompt_template_pre_pe.format(prompt)
        ...
        await edit_caption_with_retry(status_message, caption=f"An error occurred: {str(e)}")
        raise e
...
- <u>Resolution</u>: <code>1920x1080</code>
- <u>Aspect ratio</u>: <code>16:9</code>
- <u>Megapixel size</u>: <code>4MP</code> (gets overwritten by resolution)
- <u>Batch size</u>: <code>3x</code>
- <u>Modes</u>:
{}
- <u>Guidance</u>: <code>cfg=3.5</code> (1-2 for paintings, 1.5-2.5 realistic, 3.5 balanced (default), 4 flat colors/cartoon)
- <u>Steps</u>: <code>s=20</code>
- <u>Seed</u>: <code>seed=123456789</code> (random by default)
- <u>Prompt enhancement</u>:
{}

Example: "Create a landscape with mountains <code>1920x1080 2x</code>"
